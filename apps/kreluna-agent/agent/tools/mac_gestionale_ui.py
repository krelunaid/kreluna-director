...
def run(payload: dict) -> None:
    ...
    root = tk.Tk()
    root.title("Gestionale Fatture  ·  PC-FATTURE")
    ...
    tk.Label(root, text="Gestionale Fatture", bg=navy, fg="#f4efe4", font=("Helvetica", 18, "bold"), anchor="w", padx=20, pady=14).pack(fill="x")
